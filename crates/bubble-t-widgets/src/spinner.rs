...
//!
//! ```rust
//! use bubble_t_widgets::spinner::{new, with_spinner, with_style, DOT};
...
//!
//! struct MyApp {
//!     spinner: bubble_t_widgets::spinner::Model,
//! }
//!
...
///
/// ```rust
/// use bubble_t_widgets::spinner::Spinner;
/// use std::time::Duration;
///
...
///
/// TickMsg is used by the bubble-t event system to trigger spinner animation updates.
...
///
/// ```rust
/// use bubble_t_widgets::spinner::{new, DOT};
/// use bubble_t_widgets::spinner::{with_spinner};
///
/// let spinner = new(&[with_spinner(DOT.clone())]);
...
///
/// ```rust
/// use bubble_t_widgets::spinner::{new, with_spinner, DOT};
/// use lipgloss_extras::prelude::*;
///
/// let mut spinner = new(&[
///     with_spinner(DOT.clone())
...
///
/// ```rust
/// use bubble_t_widgets::spinner::{new, with_style};
/// use lipgloss_extras::prelude::*;
///
...
impl Model {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::spinner::Model;
    ///
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::spinner::{Model, with_spinner, DOT};
    ///
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::spinner::{Model, DOT};
    ///
    ...
    ///
    /// This method creates a TickMsg that can be sent through the bubble-t
    ...
    /// Creates a bubble-t command to schedule the next tick.
    ///
...
impl Model {
    ...
    ///
    /// This is the standard bubble-t update function that processes incoming messages.
    ...
    /// It's the standard bubble-t view function that produces the visual output.
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::spinner::{new, with_spinner, LINE};
    ///
...
mod tests {
    use super::*;
    use crate::spinner::{
        DOT, ELLIPSIS, GLOBE, HAMBURGER, JUMP, LINE, METER, MINI_DOT, MONKEY, MOON, POINTS, PULSE,
        dot, line, new, new_model, tick, with_spinner, with_style,
    };
