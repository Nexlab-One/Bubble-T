...
use super::keymap::{KeyMap, default_key_map};
...
///
/// ```rust
/// use bubble_t_widgets::textinput::{new, EchoMode};
/// use bubble_t::Model;
///
...
///
/// ```rust
/// use bubble_t_widgets::textinput::new_model;
///
/// let input = new_model();
/// ```
///
...
/// ```
pub fn blink() -> Cmd {
    use bubble_t::tick as bubbletea_tick;
    let id = 0usize;
    let tag = 0usize;
...
///
/// ```rust
/// use bubble_t_widgets::textinput::paste;
///
