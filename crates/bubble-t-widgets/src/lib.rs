#![warn(missing_docs)]
#![doc(html_root_url = "https://docs.rs/bubble-t-widgets/")]

//! # bubble-t-widgets
//!
//! A Rust port of the Go library [charmbracelet/bubbles](https://github.com/charmbracelet/bubbles),
//! providing reusable TUI components for building terminal applications with [bubble-t](https://github.com/Nexlab-One/Bubble-T).
//!
//! [![Crates.io](https://img.shields.io/crates/v/bubble-t-widgets.svg)](https://crates.io/crates/bubble-t-widgets)
//! [![Documentation](https://docs.rs/bubble-t-widgets/badge.svg)](https://docs.rs/bubble-t-widgets)
//! [![License](https://img.shields.io/badge/license-MIT-blue.svg)](https://opensource.org/licenses/MIT)
//!
//! ## Overview
//!
//! bubble-t-widgets offers a collection of common terminal UI components that can be easily integrated
//! into bubble-t applications. Each component follows the Elm Architecture pattern with
...
//!
//! ```rust
//! use bubble_t_widgets::key::{Binding, KeyMap};
...
//!
//! Components are designed to work seamlessly with bubble-t models:
//!
//! ```rust
//! use bubble_t_widgets::prelude::*;
...
//! ## Quick Start
//!
//! Add bubble-t-widgets to your `Cargo.toml`:
//!
//! ```toml
//! [dependencies]
...
/// across all bubble-t-widgets components. Components that implement this trait can
...
pub use key::{
    Binding, Help as KeyHelp, KeyMap, KeyPress, matches, matches_binding, new_binding,
    with_disabled, with_help, with_keys,
};
...
pub use spinner::{
    DOT, ELLIPSIS, GLOBE, HAMBURGER, JUMP, LINE, METER, MINI_DOT, MONKEY, MOON, Model as Spinner,
    POINTS, PULSE, SpinnerOption, TickMsg as SpinnerTickMsg, new as spinner_new, with_spinner,
    with_style,
};
pub use stopwatch::Model as Stopwatch;
pub use table::Model as Table;
pub use textarea::{
    LineInfo, Model as TextArea, PasteErrMsg as TextAreaPasteErrMsg, PasteMsg as TextAreaPasteMsg,
    default_styles as textarea_default_styles, new as textarea_new,
};
pub use textinput::{
    EchoMode, KeyMap as TextInputKeyMap, Model as TextInput, PasteErrMsg, PasteMsg, ValidateFunc,
    blink, default_key_map as textinput_default_key_map, new as textinput_new, paste,
};
pub use timer::{
    Model as Timer, StartStopMsg as TimerStartStopMsg, TickMsg as TimerTickMsg,
    TimeoutMsg as TimerTimeoutMsg, new as timer_new, new_with_interval as timer_new_with_interval,
};
...
/// bubble-t-widgets, allowing users to import everything they need with a single
/// `use` statement.
///
/// # Usage
///
...
///
/// ```rust
/// use bubble_t_widgets::{TextInput, List, Spinner, Component};
/// use bubble_t_widgets::key::{Binding, KeyMap};
/// ```
///
...
pub mod prelude {
    ...
    pub use crate::spinner::{
        DOT, ELLIPSIS, GLOBE, HAMBURGER, JUMP, LINE, METER, MINI_DOT, MONKEY, MOON,
        Model as Spinner, POINTS, PULSE, SpinnerOption, TickMsg as SpinnerTickMsg,
        new as spinner_new, with_spinner, with_style,
    };
    pub use crate::table::Model as Table;
    pub use crate::textarea::{
        LineInfo, Model as TextArea, PasteErrMsg as TextAreaPasteErrMsg,
        PasteMsg as TextAreaPasteMsg, default_styles as textarea_default_styles,
        new as textarea_new,
    };
    pub use crate::textinput::{
        EchoMode, KeyMap as TextInputKeyMap, Model as TextInput, PasteErrMsg, PasteMsg,
        ValidateFunc, blink, default_key_map as textinput_default_key_map, new as textinput_new,
        paste,
    };
    pub use crate::timer::{
        Model as Timer, StartStopMsg as TimerStartStopMsg, TickMsg as TimerTickMsg,
        TimeoutMsg as TimerTimeoutMsg, new as timer_new,
        new_with_interval as timer_new_with_interval,
    };
