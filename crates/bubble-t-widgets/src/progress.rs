...
//!
//! ```rust
//! use bubble_t_widgets::progress::{new, with_width, with_solid_fill};
//!
...
/// ```rust
/// use bubble_t_widgets::progress::{new, with_gradient, with_width, without_percentage};
///
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_default_gradient, with_width};
///
/// let progress = new(&[
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_gradient};
///
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_default_scaled_gradient};
///
/// let progress = new(&[
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_scaled_gradient};
///
/// let progress = new(&[
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_solid_fill, with_width};
///
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_fill_characters};
///
/// // Classic ASCII style
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, without_percentage, with_width, with_solid_fill};
///
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_width};
///
...
///
/// ```rust
/// use bubble_t_widgets::progress::{new, with_spring_options};
///
...
/// follows the Elm Architecture pattern used by bubble-t, with separate methods
...
impl Model {
    ...
    /// handled by your bubble-t application to drive the animation.
    ///
    /// # Arguments
    ///
    ...
    ///
    /// // In a real app, you'd handle this through bubble-t
    ...
    /// ## Integration Example
    /// ```rust
    /// use bubble_t_widgets::progress::{new, with_solid_fill};
    ///
    /// let progress = new(&[
    ...
    /// fn render_ui(progress: &bubble_t_widgets::progress::Model) -> String {
    ...
    /// ```rust
    /// use bubble_t_widgets::progress::{new, with_width, without_percentage};
    ///
    /// let progress = new(&[
    ///     with_width(10),
    ///     without_percentage(),
    ...
    /// use bubble_t_widgets::progress::new;
    ///
    /// fn should_update_ui(progress: &bubble_t_widgets::progress::Model) -> bool {
...
mod tests {
    use super::*;
    use crate::progress::{
        FrameMsg, new, new_model, with_default_gradient, with_fill_characters, with_gradient,
        with_solid_fill, with_spring_options, with_width, without_percentage,
    };
