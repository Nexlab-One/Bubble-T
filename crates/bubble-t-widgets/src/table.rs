...
//!
//! ```rust
//! use bubble_t_widgets::table::{Model, Column, Row, Styles};
...
///
/// ```rust
/// use bubble_t_widgets::table::Column;
///
...
///
/// ```rust
/// use bubble_t_widgets::table::Row;
///
...
/// ```rust
/// use bubble_t_widgets::table::{Column, Row};
///
/// let columns = vec![
///     Column::new("ID", 8),
...
///
/// ```rust
/// use bubble_t_widgets::table::Styles;
/// use lipgloss_extras::prelude::*;
///
...
/// ```rust
/// use bubble_t_widgets::table::{Model, Column, Styles};
/// use lipgloss_extras::prelude::*;
///
...
impl Default for Styles {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::table::{Styles, Model, Column};
    ///
...
///
/// ```rust
/// use bubble_t_widgets::table::{TableKeyMap, Model, Column};
...
/// use bubble_t_widgets::key::KeyMap as KeyMapTrait;
///
...
impl Default for TableKeyMap {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::table::TableKeyMap;
    ///
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, TableOption, with_columns, with_rows, with_height, Column, Row};
///
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, with_columns, Column};
///
/// let table = Model::with_options(vec![
///     with_columns(vec![
///         Column::new("ID", 8),
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, with_rows, Row};
///
/// let table = Model::with_options(vec![
///     with_rows(vec![
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, with_height};
///
/// let table = Model::with_options(vec![
///     with_height(25),
/// ]);
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, with_columns, with_width, Column};
///
/// let table = Model::with_options(vec![
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, with_focused};
///
/// let table = Model::with_options(vec![
///     with_focused(false),
/// ]);
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, with_styles, Styles};
/// use lipgloss_extras::prelude::*;
///
...
///
/// ```rust
/// use bubble_t_widgets::table::{Model, with_key_map, TableKeyMap};
/// use bubble_t_widgets::key;
/// use crossterm::event::KeyCode;
///
...
impl Model {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::table::{Model, with_columns, with_rows, with_height, Column, Row};
    ///
...
impl BubbleTeaModel for Model {
    ...
    /// ```rust
    /// use bubble_t_widgets::table::{Model, Column};
    /// use bubble_t::{KeyMsg, Model as BubbleTeaModel};
    ...
    /// #   }
    /// #   
    /// #   fn update(&mut self, _msg: bubble_t::Msg) -> Option<bubble_t::Cmd> {
    /// #       None
    /// #   }
    ///     
    ///     fn view(&self) -> String {
...
impl help::KeyMap for Model {
    ...
    /// ```rust
    /// use bubble_t_widgets::table::{Model, Column};
    /// use bubble_t_widgets::help::KeyMap;
    ///
    /// let table = Model::new(vec![Column::new("Data", 20)]);
