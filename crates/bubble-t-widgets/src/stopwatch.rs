...
//!
//! ```rust
//! use bubble_t_widgets::stopwatch::new_with_interval;
...
///
/// ```rust
/// use bubble_t_widgets::stopwatch::{TickMsg, Model};
/// use bubble_t::Msg;
///
...
/// Manual creation (rarely needed):
/// ```rust
/// use bubble_t_widgets::stopwatch::{ResetMsg, new};
///
/// let stopwatch = new();
...
impl Model {
    ...
    /// ```rust
    /// use bubble_t_widgets::stopwatch::{new, StartStopMsg};
    /// use bubble_t::Msg;
    ///
    /// let stopwatch = new();
    ...
    /// ```rust,ignore
    /// use bubble_t_widgets::stopwatch::{new, ResetMsg};
    /// use std::time::Duration;
    ///
    /// let mut stopwatch = new();
    ///
...
impl Default for Model {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::stopwatch::Model;
    /// use std::time::Duration;
    ///
    ...
    /// ```rust
    /// use bubble_t_widgets::stopwatch::Model as StopwatchModel;
    ///
    /// #[derive(Default)]
    /// struct App {
