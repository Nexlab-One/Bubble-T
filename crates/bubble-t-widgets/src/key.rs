...
///
/// ```rust
/// use bubble_t_widgets::key::KeyPress;
/// use crossterm::event::{KeyCode, KeyModifiers};
///
...
impl Binding {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::key::{Binding, with_keys_str, with_help};
    ///
    ...
    /// Checks if a `KeyMsg` from `bubble-t` matches this binding.
    ///
...
///
/// ```rust
/// use bubble_t_widgets::key::{KeyMap, Binding};
/// use crossterm::event::KeyCode;
///
/// struct MyComponent {
///     save: Binding,
...
///
/// ```rust
/// use bubble_t_widgets::key::{matches, Binding};
/// use bubble_t::KeyMsg;
/// use crossterm::event::{KeyCode, KeyModifiers};
///
/// let save = Binding::new(vec![(KeyCode::Char('s'), KeyModifiers::CONTROL)]);
...
///
/// ```rust
/// use bubble_t_widgets::key::{matches_binding, Binding};
/// use bubble_t::KeyMsg;
/// use crossterm::event::{KeyCode, KeyModifiers};
///
/// let binding = Binding::new(vec![(KeyCode::Char('s'), KeyModifiers::CONTROL)]);
...
///
/// ```rust
/// use bubble_t_widgets::key::{new_binding, with_keys, with_help};
/// use crossterm::event::{KeyCode, KeyModifiers};
///
/// let binding = new_binding(vec![
///     with_keys(vec![
...
///
/// ```rust
/// use bubble_t_widgets::key::{new_binding, with_keys_str, with_disabled};
///
/// let binding = new_binding(vec![
///     with_keys_str(&["f1"]),
///     with_disabled(),
...
///
/// ```rust
/// use bubble_t_widgets::key::parse_key_string;
/// use crossterm::event::{KeyCode, KeyModifiers};
///
