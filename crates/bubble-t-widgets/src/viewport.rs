...
//!
//! ```rust
//! use bubble_t_widgets::viewport::{new, Model};
//!
...
//!
//! ```rust
//! use bubble_t_widgets::viewport::{Model, ViewportKeyMap};
//! use lipgloss_extras::prelude::*;
//!
...
///
/// ```rust
/// use bubble_t_widgets::viewport::{ViewportKeyMap, Model};
...
/// ```rust
/// use bubble_t_widgets::viewport::ViewportKeyMap;
...
pub struct Model {
    ...
    /// bubble-t mouse event capabilities.
...
impl BubbleTeaModel for Model {
    ...
    /// ```rust
    /// use bubble_t_widgets::viewport::Model;
    /// use bubble_t::{Model as BubbleTeaModel, KeyMsg};
    ...
    fn update(&mut self, msg: Msg) -> Option<Cmd> {
        ...
        // Mouse wheel basic support if MouseMsg is available in bubble-t
        // Note: bubble-t MouseMsg does not currently expose wheel events in this crate version.
        None
    }
...
/// - **Import Convenience**: Shorter syntax with `use bubble_t_widgets::viewport::new`
