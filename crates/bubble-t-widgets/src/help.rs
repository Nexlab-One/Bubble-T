//! A help component for bubble-t, ported from the Go version.
//!
...
//!
//! The help component integrates seamlessly with the bubble-t architecture
...
//! use bubble_t_widgets::key::Binding;
...
//!     fn short_help(&self) -> Vec<&bubble_t_widgets::key::Binding> {
//!         vec![&self.quit_key, &self.help_key]
//!     }
//!
//!     fn full_help(&self) -> Vec<Vec<&bubble_t_widgets::key::Binding>> {
//!         vec![
...
/// ## Custom Color Scheme
/// ```rust
/// use bubble_t_widgets::help::Styles;
/// use lipgloss_extras::prelude::*;
///
...
/// ```rust
/// # use bubble_t_widgets::help::{Model, Styles};
/// # use lipgloss_extras::prelude::*;
...
/// #   fn full_help(&self) -> Vec<Vec<&bubble_t_widgets::key::Binding>> { vec![] }
/// # }
/// # impl BubbleTeaModel for MyApp {
/// #   fn init() -> (Self, Option<bubble_t::Cmd>) { (MyApp { help: Model::new() }, None) }
...
impl Model {
    ...
    ///
    /// This method provides compatibility with the bubble-t architecture,
    ...
    /// # impl KeyMap for MyApp {
    /// #     fn short_help(&self) -> Vec<&bubble_t_widgets::key::Binding> { vec![&self.quit_key] }
    /// #     fn full_help(&self) -> Vec<Vec<&bubble_t_widgets::key::Binding>> { vec![vec![&self.quit_key]] }
    /// # }
...
/// ```rust
/// # use bubble_t_widgets::help::should_render_column;
/// # use bubble_t_widgets::key::Binding;
/// # use crossterm::event::KeyCode;
