...
//! for compatibility with the bubble-t-widgets TUI library ecosystem.
//!
//! # Features
//!
...
//!
//! ```rust
//! use bubble_t_widgets::runeutil::{new_sanitizer, replace_tabs, replace_newlines};
//!
...
/// Basic sanitization:
/// ```rust
/// use bubble_t_widgets::runeutil::new_sanitizer;
///
/// let sanitizer = new_sanitizer(vec![]);
...
impl Default for Sanitizer {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::runeutil::Sanitizer;
    ///
...
///
/// ```rust
/// use bubble_t_widgets::runeutil::{SanitizerOpt, Sanitizer};
///
...
///
/// ```rust
/// use bubble_t_widgets::runeutil::{new_sanitizer, replace_tabs};
///
/// let sanitizer = new_sanitizer(vec![
...
/// ```rust
/// use bubble_t_widgets::runeutil::{new_sanitizer, replace_newlines};
///
