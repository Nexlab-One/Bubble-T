...
//!
//! ```rust
//! use bubble_t_widgets::timer::{new, new_with_interval};
...
///
/// ```rust
/// use bubble_t_widgets::timer::{TickMsg, new};
/// use std::time::Duration;
///
/// let timer = new(Duration::from_secs(30));
...
///
/// struct App {
///     timer: bubble_t_widgets::timer::Model,
///     message: String,
/// }
///
...
///
/// ```rust
/// use bubble_t_widgets::timer::new_with_interval;
/// use std::time::Duration;
///
...
impl Model {
    ...
    ///
    /// struct App {
    ///     work_timer: bubble_t_widgets::timer::Model,
    ///     break_timer: bubble_t_widgets::timer::Model,
    /// }
    ///
    /// impl BubbleTeaModel for App {
    ///     fn update(&mut self, msg: Msg) -> Option<bubble_t::Cmd> {
    ...
    ///     }
    ///
    ///     fn update(&mut self, msg: bubble_t::Msg) -> Option<Cmd> {
    ...
    ///
    /// struct App {
    ///     cooking_timer: bubble_t_widgets::timer::Model,
    ///     recipe: String,
    /// }
    ///
    /// impl BubbleTeaModel for App {
...
impl Default for Model {
    ...
    ///
    /// ```rust
    /// use bubble_t_widgets::timer::Model;
    /// use std::time::Duration;
    ///
