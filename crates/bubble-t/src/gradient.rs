...
//!
//! ```rust
//! use bubble_t::gradient::{gradient_filled_segment, charm_default_gradient, lerp_rgb};
//!
...
///
/// ```rust
/// use bubble_t::gradient::charm_default_gradient;
///
/// let (start, end) = charm_default_gradient();
...
///
/// ```rust
/// use bubble_t::gradient::lerp_rgb;
///
/// let red = (255, 0, 0);
/// let blue = (0, 0, 255);
///
...
///
/// ```rust
/// use bubble_t::gradient::gradient_filled_segment_with_buffer;
///
/// let mut buffer = String::new();
///
